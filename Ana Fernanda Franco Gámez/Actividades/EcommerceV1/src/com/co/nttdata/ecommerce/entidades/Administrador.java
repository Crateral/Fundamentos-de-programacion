...
public class Administrador extends Usuario {
    ...
    public Administrador(int id, String tipoIdentificacion,String numeroIdentificacion, String nombreUsuario,  String correo, String contrasenia, boolean estado) {
