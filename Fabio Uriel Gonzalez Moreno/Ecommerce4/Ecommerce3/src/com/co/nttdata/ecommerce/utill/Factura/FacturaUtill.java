...
public class FacturaUtill {
    Factura f = new Factura();
       ...
       public void escribirArchivo(String nombreArchivo, CarritoDeCompras cdc, GestionCarritoDeCompras gcdc, Empresa ecommerce, Cliente cliente) {
        ...
        try {
            archivo = new FileWriter("C:\\Users\\Fabio Gonzalez\\Documents\\NTTDATA\\" + nombreArchivo, false);
    ...
    public static void leerArchivo(String nombreArchivo,CarritoDeCompras cdc, GestionCarritoDeCompras gcdc, Empresa ecommerce,Cliente cliente) {
