...
public class Main extends GestionCarritoDeCompras {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            System.out.println("7. Leer Productos");
            ...
            switch (opcion) {
                ...
                case 6:
                    ...
                    facturaText.escribirArchivo("factura004.txt",cdc,gcdc,Ecommerce,cliente);
                    break;

                case 7:
                    FacturaUtill leerTxt=new FacturaUtill();
                    leerTxt.leerArchivo("prueba.txt",cdc,gcdc,Ecommerce,cliente);
