...
import static com.ecommerce.store.logica.Productos.cargarProductos;
import static com.ecommerce.store.logica.Usuarios.cargarUsuarios;
    ...
    private static void menu(int opcion){
        switch (opcion) {
            ...
            case 5:
                ...
                break;
            case 6:
                System.out.println("Cargar Datos de prueba Finalizado\n");
                cargarProductos();
                cargarUsuarios();
                break;
            default:
