...
import com.ecommerce.store.logica.UsuarioEstado;
import com.ecommerce.store.logica.Usuarios;

import java.util.InputMismatchException;
import java.util.Scanner;

public class MainAdmin implements Vistas {
    ...
    private void menu(int opcion){
        switch (opcion) {
            ...
            case 5:
                ...
                break;
            case 6:
                UsuarioEstado modificarEstado = new UsuarioEstado();
                modificarEstado.vistaPantalla();
                break;
            case 7:
